    ...
    for (i=0; i < elements.length; i++) {
        if (elements[i].type != "button" && elements[i].type != "submit" &&
            ...
            if (elements[i].getAttribute('readonly') != "readonly" && elements[i].getAttribute('readonly') != "disabled") {
                elements[i].onfocus=function() {var focusElement = $(this);focusElement.addClassName('focus');this.select();};
                elements[i].onblur=function() {var focusElement = $(this);focusElement.removeClassName('focus');};
            }
        }
    }
}
